...
import edu.gac.polisci.client.BlobService;
...
public class BlobServiceImpl extends RemoteServiceServlet implements
  ...
  public String getBlobStoreUploadUrl() {
	...
	//  the web page "/thesisdb/uploadservice" will be served to the 
    ...
    return 
      blobstoreService.createUploadUrl("/thesisdb/uploadservice");
  }
