...
public interface clientModelServiceAsync {
	...
	void getThesesDataFromServer(boolean isFeatured, AsyncCallback<List<Thesis>> callback);
	void getSearchThesesDataFromServer(String search, boolean isFeatured, AsyncCallback<List<Thesis>> callback);
	...
	void getFilterThesesDataFromServer(List<String> tagFilters, List<String> yearFilters,
			List<String> profFilters, List<String> classFilters, boolean isFeatured, AsyncCallback<List<Thesis>> callback);
